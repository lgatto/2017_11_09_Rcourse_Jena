...
marup language, rather than LaTeX. Once interleaved with R code
...
chunk and incoporates their output in the resulting markdown
documents, which itselft is converted to one of many output formats,
...
- Among the most optiosn that can set for code chunks is

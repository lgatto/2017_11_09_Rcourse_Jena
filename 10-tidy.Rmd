...
> This material is based on the Data Carpentry
> [Data Organization in Spreadsheets](http://www.datacarpentry.org/spreadsheet-ecology-lesson/) lesson.

## Introduction

![](./figs/analysis.png)

However, most time is spend in clearning up and preparing the data,
rather than actually analysing it.

![](./figs/families.jpg)

> Like families, tidy datasets are all alike but every messy dataset
> is messy in its own way - (Hadley Wickham)

An example of a really messy data!
...
- Keeping track of your analyses, using a `REAMDE` file for instance.
...
another column to your original spreadsheet.
...
headers at the tnop of the spreadsheet. But don't repeat your header
...
![White et al.](../figs/3_white_table_1.png)
...
![formatting](../figs/formatting.png)

**Solution**: create a new field to encode which data should be excluded.

![good formatting](../figs/good_formatting.png)
...
programs don’t like field names that are text strings that start
with numbers.
...
- Avoid spreading data across multiple tabs (but do use a new tab to
  record data cleaning or manipulations).

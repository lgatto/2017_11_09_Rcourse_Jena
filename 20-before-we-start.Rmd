...
![RStudio interface screenshot](./figs/rstudio-screenshot.png)
...
![](./figs/r-starting-how-it-should-look-like.png)
...
![Example of a working directory structure](./figs/working-directory-structure.png)
...
![](./figs/kitten-try-things.jpg)

## Seeking help

### Use the built-in RStudio help interface to search for more information on R functions

![RStudio help interface](./figs/rstudiohelp.png)

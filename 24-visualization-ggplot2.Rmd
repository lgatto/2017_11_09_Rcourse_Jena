...
```{r load-package2, message=FALSE, purl=FALSE}
library(tidyverse)
```
...
> `species_id` with the plot types showing in different colors.  Is
...
arrangements, there are tools
for
[constucting more complex layouts](https://cran.r-project.org/web/packages/gridExtra/vignettes/arrangeGrob.html).
